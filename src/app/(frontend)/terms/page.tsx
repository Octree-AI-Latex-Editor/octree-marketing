    ...
    <article className="pt-24 pb-16 px-4">
      <div className="max-w-3xl mx-auto prose prose-neutral prose-headings:font-heading">
        ...
        <p>
          ...
          Conditions (&ldquo;Terms&rdquo;). If you do not agree to these Terms, please do not use our Service.
        </p>
        ...
        <h3>4.1 Free Tier</h3>
        <p>
          The Starter plan includes limited free AI edits per day and basic features as 
        ...
        <h3>5.1 Ownership</h3>
        <p>
          You retain all rights to the documents and content you create using our Service. 
        ...
        <p>
          ...
          is owned by Octree and protected by intellectual property laws. You may not copy, 
          modify, or distribute our proprietary materials.
        </p>

        <h2>8. AI Features</h2>
        <p>
          Our AI-powered features are provided &ldquo;as is.&rdquo; While we strive for accuracy, AI 
          suggestions may contain errors. You are responsible for reviewing and verifying 
        ...
        <p>
          ...
          by posting the updated Terms and changing the &ldquo;Last updated&rdquo; date. Continued use 
